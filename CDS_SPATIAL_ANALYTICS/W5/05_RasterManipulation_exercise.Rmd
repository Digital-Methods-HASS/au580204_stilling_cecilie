...
elevation <- raster("C:/Users/cecil/OneDrive/AU/Spatial Analytics/Assignments/cds-spatial/data/Aster.tif")
...
# Create 'mounds'
mounds <- st_read("C:/Users/cecil/OneDrive/AU/Spatial Analytics/Assignments/cds-spatial/data/KAZ_mounds.shp")

# Check is crs matches
st_crs(elevation) == st_crs(mounds) #CRS matches 

# If it did not match we would have used st_transform to fix

# Create bounding box
mounds_bb <- st_make_grid(mounds)

# Plot mounds_bb and mounds to see how they relate
plot(mounds_bb)
plot(st_geometry(mounds), add=TRUE)


# Crop elevation layer by mounds object and create smaller elev object
...
survey <- st_read("C:/Users/cecil/OneDrive/AU/Spatial Analytics/Assignments/cds-spatial/data/KAZ_units.shp")

# Check is crs matches
st_crs(survey) == st_crs(elev) #CRS matches

# Compute the area of the survey
areas <- st_area(survey) #m^2
...
east <- raster("C:/Users/cecil/OneDrive/AU/Spatial Analytics/Assignments/cds-spatial/data/KazE.tif")
...
elevation
prominence <- raster("C:/Users/cecil/OneDrive/AU/Spatial Analytics/Assignments/cds-spatial/data/prominence1500m.tif")
...
elevation_c <- raster::crop(elevation, prominence)

# Do the overlay using f as fun. 
elevation_prom_overlay <- overlay(elevation_c, prominence, fun = f)
...
# Make an object of mounds that sit within these strategic high-visibility locations. How many are there?
# Using crop() to make object
mounds_hv <- raster::crop(elevation_prom_overlay, mounds) 

# Using ncell to figure out how many there are 
ncell(mounds_hv) #369930
#plotting just for the fun of it
plot(mounds_hv)
...
# unique() returns the unique values in a RasterLayer object or the unique combinations of the layers in a multilayer object.
unique(mounds_top25$TRAP_Code) # 2002 3112 3105 4057 4058 3722 4059 3417 4056 3276 3024 1020 4087 1019 3026 2028 4066 5002 4086 1071 3275 2003 2004 3703 3420
...
not quite sure how I can see this?
